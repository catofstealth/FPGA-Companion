...
const char * core_spectrum_default_images[] = {
  CARD_MOUNTPOINT "/spec.tap",
  CARD_MOUNTPOINT "/spec.tzx",
...
static const char main_form_spectrum[] =
  "SpecTangNano,;"                           // main form has no parent
  // --------
...
static const char system_form_spectrum[] =
  ...
  "L,Rom:,Original|GoshWonderful|128k|2+|3+|Retroleum,D;"
//  "L,Swap Joyst:,Off|On,&;"
//  "L,REU 1750:,Off|On,V;"
...
static const char storage_form_spectrum[] =
  "Storage,0|3;"                        // return to form 0, entry 3
  // --------
  "F,TAP Tape:,0|tap;"                  // fileselector for TAP
  "F,TZX Tape:,0|tzx;";                  // fileselector for TAP
...
static const char settings_form_spectrum[] =
...
const char *core_spectrum_forms[] = {
  main_form_spectrum,
  system_form_spectrum,
  storage_form_spectrum,
  settings_form_spectrum
};

menu_legacy_variable_t core_spectrum_variables[] = {
...
const unsigned char core_spectrum_keymap[] = {
  MISS,         // 00: NoEvent
...
const unsigned char core_spectrum_modifier[] = {
  /* usb modifer bits:
     0     1      2    3    4     5      6    7
